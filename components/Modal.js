...
function Modal() {
    ...
    const uploadPost = async () => {
        ...
        const docRef = await addDoc(collection(db , 'posts'), {
            ...
            profileImag: session.user.image,
  ...
  return (
    <Transition.Root show={open} as={Fragment}>
        ...
        <Dialog onClose={setOpen} as="div" className="fixed z-10 inset-0 overflow-y-auto">
            <div className="flex items-center justify-between min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <Transition.Child
            as={Fragment}
                 ...
                 <div>
                     ...
                     <div>
                         <div className="mt-3 text-center sm:mt-5">
                            ...
                            <div>
                                <input onChange={addImageToPost} ref={filePickerRef} hidden type="file" />
                            </div>

                            <div className="mt-2">
                                <input ref={captionRef} className="border-none focus:ring-0 w-full text-center" placeholder="por favor ensira algun texto" type="text" />
                            </div>
                         </div>
                     </div>
                        ...
                        <button
                        disabled={!selectedFile} onClick={uploadPost} type="button"
